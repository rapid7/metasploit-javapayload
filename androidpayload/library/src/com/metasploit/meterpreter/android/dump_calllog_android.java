...
public class dump_calllog_android implements Command {
	...
	private static final int TLV_TYPE_CALLLOG_NAME = TLVPacket.TLV_META_TYPE_STRING | (TLV_EXTENSIONS + 9013);
	private static final int TLV_TYPE_CALLLOG_TYPE = TLVPacket.TLV_META_TYPE_STRING | (TLV_EXTENSIONS + 9014);
	private static final int TLV_TYPE_CALLLOG_DATE = TLVPacket.TLV_META_TYPE_STRING | (TLV_EXTENSIONS + 9015);
	private static final int TLV_TYPE_CALLLOG_DURATION = TLVPacket.TLV_META_TYPE_STRING | (TLV_EXTENSIONS + 9016);
	private static final int TLV_TYPE_CALLLOG_GROUP = TLVPacket.TLV_META_TYPE_GROUP | (TLV_EXTENSIONS + 9017);
	private static final int TLV_TYPE_CALLLOG_NUMBER = TLVPacket.TLV_META_TYPE_STRING | (TLV_EXTENSIONS + 9018);
